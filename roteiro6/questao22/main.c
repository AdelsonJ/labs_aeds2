...
int main(){
    ...
    int *prio_inicio = (int*)malloc(sizeof(int));
    FilaP *filap;
    ...
    do{
        ...
        case 3:
            if(verIni(filap, inicio, prio_inicio) == 1)
                printf("O valor inicial da fila e sua prioridade eh: (%d,%d)", 
                *inicio, *prio_inicio);
            else
                printf("Fila vazia");
            aguardaLimpa();
        ...
        case 6:
            printf("O tamanho da Fila de Prioridade eh  %d", filap->qtd);
            aguardaLimpa();
            break;
